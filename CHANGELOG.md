...
- `__version__` now reads from package metadata so it stays in sync with `pyproject.toml`.
- Release workflow now correctly extracts the CHANGELOG section for GitHub releases.
